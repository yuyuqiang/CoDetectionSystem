...
public class Car {
    ...
    private String detail_tv;

    public Car(int car_iv, int warn_iv, String name_tv, String name1_tv, String phone_tv, String phone1_tv, String gender_tv, String gender1_tv, int license_iv, String license_tv, int sensor_iv1, int sensor_iv2, String co_one_tv, String co_two_tv, String danwei1, String danwei2,String detail_tv) {
        this.car_iv = car_iv;
    ...
    public String getDetail_tv() {
        return detail_tv;
    }

    public void setDetail_tv(String detail_tv) {
        this.detail_tv = detail_tv;
    }
}
